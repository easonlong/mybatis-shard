...
public class ProxyMapperScannerConfigurer implements BeanDefinitionRegistryPostProcessor, InitializingBean,
	...
	/**
	 * multiple slave nodes, split with ","
	 * 
	 */
  ...
  */
	public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
		...
		scanner.setWriteSqlSessionFactoryBeanName(this.writeSqlSessionFactoryBeanName);
		scanner.setWriteSqlSessionFactory(this.writeSqlSessionFactory);
		...
		if (this.readSqlSessionFactory != null) {
			List<SqlSessionFactory> readSqlSessionFactorys = new ArrayList<SqlSessionFactory>();
			readSqlSessionFactorys.add(this.readSqlSessionFactory);
	...
	private void processPropertyPlaceHolders() {
		...
		if (!prcs.isEmpty() && this.applicationContext instanceof GenericApplicationContext) {
			BeanDefinition mapperScannerBean = ((GenericApplicationContext) this.applicationContext).getBeanFactory()
	...
	public void setWriteSqlSessionFactoryBeanName(String writeSqlSessionFactoryBeanName) {
	...
	public void setReadSqlSessionFactoryBeanName(String readSqlSessionFactoryBeanName) {
	...
	public void setReadSqlSessionFactoryBeanNames(String readSqlSessionFactoryBeanNames) {
